...
|------------|------------|---------|
| **Neural Watermarking** | AudioSeal (40-bit) + PERTH | Invisible, compression-resistant watermarks with sample-accurate localization |
| **AI Metadata Extraction** | CLAP + MERT + Demucs | Auto-detected genre, mood, BPM, key, instruments, and stems |
| **High-Speed Acceleration** | Ohnrscript DOD Runtime | 2.56B samples/sec DSP, zero-alloc CBOR serialization |
| **Fingerprinting** | Chromaprint | Duplicate detection across all registered audio |
| **Similarity Search** | MERT/CLAP embeddings + pgvector | Find covers, remixes, and similar tracks |
